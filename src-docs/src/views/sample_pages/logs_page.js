...
const QUERY_DATA = {
  ...
  'auth-failures': [
    { id: '1', FlightNum: 'BX72KLP', Origin: 'Narita International Airport', Dest: 'São Paulo–Guarulhos International Airport', FlightDelayMin: 190 },
    { id: '2', FlightNum: 'QR41VNE', Origin: 'Hamad International Airport', Dest: 'Los Angeles International Airport', FlightDelayMin: 30 },
    { id: '3', FlightNum: 'JT88MWC', Origin: 'Suvarnabhumi Airport', Dest: 'Frankfurt Airport', FlightDelayMin: 220 },
    { id: '4', FlightNum: 'PL03DFR', Origin: 'Incheon International Airport', Dest: 'Dubai International Airport', FlightDelayMin: 85 },
    { id: '5', FlightNum: 'NK56YHT', Origin: 'John F. Kennedy International Airport', Dest: 'Heathrow Airport', FlightDelayMin: 310 },
    { id: '6', FlightNum: 'WZ19QAB', Origin: 'Singapore Changi Airport', Dest: 'Sydney Kingsford Smith Airport', FlightDelayMin: 55 },
    { id: '7', FlightNum: 'CV84RTE', Origin: 'Indira Gandhi International Airport', Dest: 'Kuala Lumpur International Airport', FlightDelayMin: 175 },
    { id: '8', FlightNum: 'MH37UPO', Origin: 'O\'Hare International Airport', Dest: 'Charles de Gaulle Airport', FlightDelayMin: 140 },
    { id: '9', FlightNum: 'DF62SLK', Origin: 'Hong Kong International Airport', Dest: 'Taipei Taoyuan International Airport', FlightDelayMin: 25 },
    { id: '10', FlightNum: 'AX95WBN', Origin: 'Istanbul Airport', Dest: 'Amsterdam Airport Schiphol', FlightDelayMin: 200 },
    { id: '11', FlightNum: 'RG28HJD', Origin: 'Hartsfield-Jackson Atlanta International Airport', Dest: 'Mexico City International Airport', FlightDelayMin: 95 },
    { id: '12', FlightNum: 'TK51CZX', Origin: 'Beijing Capital International Airport', Dest: 'Kansai International Airport', FlightDelayMin: 265 },
    { id: '13', FlightNum: 'UE74FGM', Origin: 'Zurich Airport', Dest: 'Cape Town International Airport', FlightDelayMin: 330 },
    { id: '14', FlightNum: 'YP16NVR', Origin: 'Toronto Pearson International Airport', Dest: 'Jorge Chávez International Airport', FlightDelayMin: 110 },
    { id: '15', FlightNum: 'LW43BQS', Origin: 'Munich Airport', Dest: 'Doha Hamad International Airport', FlightDelayMin: 70 },
    { id: '16', FlightNum: 'HN89XTL', Origin: 'San Francisco International Airport', Dest: 'Haneda Airport', FlightDelayMin: 185 },
    { id: '17', FlightNum: 'GK02YMW', Origin: 'Barcelona-El Prat Airport', Dest: 'Bogotá El Dorado International Airport', FlightDelayMin: 250 },
    { id: '18', FlightNum: 'FJ57APE', Origin: 'Copenhagen Airport', Dest: 'Johannesburg OR Tambo International Airport', FlightDelayMin: 40 },
    { id: '19', FlightNum: 'SO31DKR', Origin: 'Guangzhou Baiyun International Airport', Dest: 'Auckland Airport', FlightDelayMin: 295 },
    { id: '20', FlightNum: 'XC68VHJ', Origin: 'Vienna International Airport', Dest: 'Montréal-Trudeau International Airport', FlightDelayMin: 160 },
    { id: '21', FlightNum: 'BI45GNP', Origin: 'Dallas/Fort Worth International Airport', Dest: 'Rome Fiumicino Airport', FlightDelayMin: 215 },
    { id: '22', FlightNum: 'EW90TRC', Origin: 'Lisbon Humberto Delgado Airport', Dest: 'Chhatrapati Shivaji Maharaj International Airport', FlightDelayMin: 130 },
  ],
  'slow-queries': [
