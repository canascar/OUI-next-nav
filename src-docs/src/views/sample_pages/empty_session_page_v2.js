 ...
 */
export const EmptySessionPageV2 = ({
  onStartThread,
  onOpenPage,
  ...
  const [widgetSizes, setWidgetSizes] = useState({ 'deployment-timeline': 2 });
      ...
      <div className="emptySessionPage__panel">
        ...
        <div className="emptySessionPage__twoCol">
          ...
          <div className="emptySessionPage__leftCol">
            ...
            <p className="emptySessionPage__narrativePara emptySessionPage__newsSummary emptySessionPage__briefingFadeIn" style={{ width: '100%', maxWidth: 480 }}>
              <strong>244 of 247</strong> services healthy. No degradation,
              no cascading failures. 3 findings need your attention.
            </p>
            ...
            {/* Page shortcuts — quick-jump pills below input */}
            <div className="emptySessionPage__pageShortcuts">
              <span className="emptySessionPage__pageShortcutsLabel">Jump to</span>
              {WORKFLOW_ITEMS_PRIMARY.map((item, i) => (
                <button
                  key={i}
                  type="button"
                  className="emptySessionPage__shortcutPill"
              ...
              <button
                type="button"
                className="emptySessionPage__shortcutPill"
                onClick={() => onOpenPageInNewSession('alerts', 'Alerts')}>
              ...
              <OuiToolTip content="More" position="top">
                <button
                  type="button"
                  className="emptySessionPage__shortcutMore"
                  onClick={() => {
            ...
            <div
              ...
              {!workflowsExpanded && (
                <div className="emptySessionPage__tabRow emptySessionPage__tabRow--sticky">
                  <div className="emptySessionPage__panelTabs">
                    <button
                      type="button"
                      className={`emptySessionPage__panelTab${rightPanelTab === 'overview' ? ' emptySessionPage__panelTab--active' : ''}`}
                      onClick={() => setRightPanelTab('overview')}>
                      Overview
                      <span className="emptySessionPage__panelTabDot" />
                    </button>
                    <button
                      type="button"
                      className={`emptySessionPage__panelTab${rightPanelTab === 'favorites' ? ' emptySessionPage__panelTab--active' : ''}`}
              ...
              <div className="emptySessionPage__briefingContent">
                {rightPanelTab === 'favorites' ? (
                  <div className="emptySessionPage__favoritesPanel">
                    <div className="emptySessionPage__favSection">
                      ...
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        onClick={() => onOpenPageInNewSession('dashboards', 'Service overview')}>
                        <div className="emptySessionPage__favItemInfo">
                          <strong>Service overview</strong>
                          <span className="emptySessionPage__favItemMeta">12 panels &middot; opened 2h ago</span>
                        </div>
                        <svg className="emptySessionPage__favItemSpark" viewBox="0 0 60 20">
                          <defs><ChartTexture id="favStripe1" variant="stripe" color="#1F9D6B" /></defs>
                          <path d="M0,14 L10,10 L20,12 L30,8 L40,10 L50,6 L60,8 V20 H0 Z" fill="url(#favStripe1)" />
                      ...
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        onClick={() => onOpenPageInNewSession('dashboards', 'p99 latency')}>
                        <div className="emptySessionPage__favItemInfo">
                          <strong>p99 latency</strong>
                          <span className="emptySessionPage__favItemMeta">8 panels &middot; opened today</span>
                        </div>
                        <svg className="emptySessionPage__favItemSpark" viewBox="0 0 60 20">
                          <defs><ChartTexture id="favStripe2" variant="stripe" /></defs>
                          <path d="M0,16 L10,14 L20,12 L30,10 L40,8 L50,6 L60,4 V20 H0 Z" fill="url(#favStripe2)" />
                      ...
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        onClick={() => onOpenPageInNewSession('dashboards', 'Error rate by service')}>
                        <div className="emptySessionPage__favItemInfo">
                          <strong>Error rate by service</strong>
                          <span className="emptySessionPage__favItemMeta">6 panels &middot; opened yesterday</span>
                        </div>
                        <svg className="emptySessionPage__favItemSpark" viewBox="0 0 60 20">
                          <defs><ChartTexture id="favStripe3" variant="stripe" color="#ef4444" /></defs>
                          <path d="M0,16 L10,12 L20,14 L30,8 L40,10 L50,4 L60,6 V20 H0 Z" fill="url(#favStripe3)" />
                    ...
                    <div className="emptySessionPage__favSection">
                      <span className="emptySessionPage__favSectionTitle">Saved queries</span>
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        onClick={() => onOpenPageInNewSession('logs', '5xx by service')}>
                        <div className="emptySessionPage__favItemInfo">
                          <strong>5xx by service</strong>
                          <span className="emptySessionPage__favItemMeta">last 1h &middot; Logs</span>
                        </div>
                      </button>
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        onClick={() => onOpenPageInNewSession('logs', 'Slow traces > 2s')}>
                        <div className="emptySessionPage__favItemInfo">
                          <strong>Slow traces &gt; 2s</strong>
                          <span className="emptySessionPage__favItemMeta">all services &middot; Traces</span>
                        </div>
                      </button>
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        onClick={() => onOpenPageInNewSession('metrics', 'Memory pressure events')}>
                        <div className="emptySessionPage__favItemInfo">
                          <strong>Memory pressure events</strong>
                          <span className="emptySessionPage__favItemMeta">last 24h &middot; Metrics</span>
                        </div>
                      </button>
                    </div>

                    <div className="emptySessionPage__favSection">
                      <span className="emptySessionPage__favSectionTitle">Pinned sessions</span>
                      <button
                        type="button"
                        className="emptySessionPage__favItem"
                        ...
                        <div className="emptySessionPage__favItemInfo">
                          ...
                          <span className="emptySessionPage__favItemMeta">Yesterday &middot; 12 messages</span>
                        </div>
                      </button>
                      <button
                        type="button"
                        ...
                        <div className="emptySessionPage__favItemInfo">
                          ...
                          <span className="emptySessionPage__favItemMeta">2 days ago &middot; 8 messages</span>
                        </div>
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="emptySessionPage__pageBrowser">
                    <div className="emptySessionPage__pageBrowserTitleRow">
                      <span className="emptySessionPage__pageBrowserTitle">Open a page</span>
                      <button
                        type="button"
                ...
                <div className="emptySessionPage__briefingPanel">
                  {/* Findings widget */}
                  <div className="emptySessionPage__widgetWrap emptySessionPage__widget--wide" style={{ marginBottom: 12 }}>
                    <OuiInsightCard>
                      <WidgetHeader title="Findings" />
                      <div className="emptySessionPage__briefingNarrative emptySessionPage__briefingNarrative--news emptySessionPage__briefingNarrative--compact">
                        ...
                        {briefingPhase === 'done' && (
                          <>
                            <div
                              className={`emptySessionPage__newsItem emptySessionPage__briefingFadeIn${highlightedFinding === 'latency' ? ' emptySessionPage__newsItem--active' : ''}`}
                              onClick={() => setHighlightedFinding(highlightedFinding === 'latency' ? null : 'latency')}>
                              ...
                              {highlightedFinding === 'latency' && (
                                <div className="emptySessionPage__findingDetail">
                                  <span className="emptySessionPage__findingDetailText">
                                    <strong>P99 2,340ms</strong> · Pool 98% · 3/4 pods affected · 15 min ago
                                  </span>
                                  <button
                                    type="button"
                                    className="emptySessionPage__findingAction"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      onStartThread('Investigate payment service P99 latency breach — connection pool exhaustion on 3 of 4 pods');
                                    }}>
                                    Investigate <OuiIcon type="arrowRight" size="s" />
                                  </button>
                                </div>
                              )}
                            </div>
                            <div
                              className={`emptySessionPage__newsItem emptySessionPage__briefingFadeIn emptySessionPage__briefingFadeIn--2${highlightedFinding === 'checkout' ? ' emptySessionPage__newsItem--active' : ''}`}
                              onClick={() => setHighlightedFinding(highlightedFinding === 'checkout' ? null : 'checkout')}>
                              ...
                              {highlightedFinding === 'checkout' && (
                                <div className="emptySessionPage__findingDetail">
                                  <span className="emptySessionPage__findingDetailText">
                                    <strong>66% fault rate</strong> · auth-service regression · not customer-impacting yet
                                  </span>
                                  <button
                                    type="button"
                                    className="emptySessionPage__findingAction"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      onStartThread('Investigate checkout error-rate spike tied to auth-service regression');
                                    }}>
                                    Investigate <OuiIcon type="arrowRight" size="s" />
                                  </button>
                                </div>
                            ...
                            <div
                              className={`emptySessionPage__newsItem emptySessionPage__briefingFadeIn emptySessionPage__briefingFadeIn--3${highlightedFinding === 'dns' ? ' emptySessionPage__newsItem--active' : ''}`}
                              onClick={() => setHighlightedFinding(highlightedFinding === 'dns' ? null : 'dns')}>
                              <span className="emptySessionPage__newsBadge emptySessionPage__newsBadge--warning">
                                Warning
                              </span>
                              <span className="emptySessionPage__newsBody">
                                <NarrativeLink
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    onSelectSession('dns-timeout-session');
                                  }}>
                              ...
                              {highlightedFinding === 'dns' && (
                                <div className="emptySessionPage__findingDetail">
                                  <span className="emptySessionPage__findingDetailText">
                                    <strong>3h unresolved</strong> · intermittent failures · monitoring active
                                  </span>
                                  <button
                                    type="button"
                                    className="emptySessionPage__findingAction"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      onStartThread('Investigate DNS resolution timeout — flagged 3 hours ago, monitoring for recurrence');
                                    }}>
                                    Investigate <OuiIcon type="arrowRight" size="s" />
                                  </button>
                                </div>
                  ...
                  <div
                    ...
                    }${highlightedFinding ? ` emptySessionPage__widgetGrid--highlight-${highlightedFinding}` : ''}`}
                    ref={insightsRef}
