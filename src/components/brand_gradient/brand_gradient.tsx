...
const GRADIENTS = {
  subtle: {
    dark: `radial-gradient(ellipse at 20% 30%, rgba(0, 184, 219, 0.14) 0%, transparent 55%),
           radial-gradient(ellipse at 80% 70%, rgba(0, 105, 170, 0.10) 0%, transparent 55%),
           #111`,
  ...
  vivid: {
    dark: `radial-gradient(ellipse at 15% 25%, rgba(0, 184, 219, 0.28) 0%, transparent 50%),
           radial-gradient(ellipse at 75% 65%, rgba(0, 105, 170, 0.22) 0%, transparent 50%),
           radial-gradient(ellipse at 50% 50%, rgba(0, 150, 200, 0.08) 0%, transparent 70%),
           #111`,
  ...
  radial: {
    dark: `radial-gradient(ellipse at 50% 40%, rgba(0, 184, 219, 0.24) 0%, transparent 45%),
           radial-gradient(ellipse at 50% 60%, rgba(0, 105, 170, 0.16) 0%, transparent 55%),
           #111`,
